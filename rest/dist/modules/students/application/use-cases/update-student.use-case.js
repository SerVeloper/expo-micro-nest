...
let UpdateStudentUseCase = class UpdateStudentUseCase {
    ...
    async execute(id, updateStudentDto) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Error al actualizar estudiante con id ${id}`);
        }
    }
};
...
//# sourceMappingURL=update-student.use-case.js.map